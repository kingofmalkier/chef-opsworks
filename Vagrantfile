...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "base-iso-with-chef"
  ...
  config.vm.provision :chef_client do |chef|
    chef.chef_server_url = "https://api.opscode.com/organizations/onefootsoftware"
    chef.validation_client_name = "onefootsoftware-validator"
    chef.validation_key_path = ".chef/onefootsoftware-validator.pem"
    chef.add_role "starter"
  end
end
